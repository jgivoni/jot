...
//			new \Ophp\AlphanumFilter(), // Only alphanumeric characters
			new \Ophp\IssetFilter(), // Must have a value (other than null)
...
//			new \Ophp\StrNotEmpty(), // Must not be an empty string
		...
		$this->addFilter(new \Ophp\MutualDependencyFilter(
			new \Ophp\ParamFilter('longitude', new \Ophp\IssetFilter()), new \Ophp\ParamFilter('latitude', new \Ophp\IssetFilter())
		));
